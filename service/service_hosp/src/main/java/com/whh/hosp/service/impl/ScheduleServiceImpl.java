...
import com.whh.hosp.repository.ScheduleRepository;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleDao, Schedule> implements ScheduleService {
    ...
    @Resource
    private MongoTemplate mongoTemplate;//基于MongoTemplate 的CRUD开发
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        ...
        scheduleList.stream().forEach(item->{  //lambada表达式
